                ...
                <div class="row-fluid ">
                  <div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                    <div id="hs_cos_wrapper_module_16310982122473" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                      <div id="" class="atmc-image-default  sr-invisible fadeInBottom ">
                        <div>
                          <img loading="lazy" src="{static}/images/products/alerting/Alerting_Maintenance_Schedule_960x1002.gif" alt="Website Downtime Monitoring Alert Notifications with Uptime.com" width="100%" style="max-width: 480px; max-height: 501px">
                        </div>
                      </div>
                    </div>
                  </div>
